                      ...
                      children: [
                        Container(
                          ...
                          child: ClipRRect(
                            borderRadius: BorderRadius.circular(50),
                            child: Image.asset(
                              'assets/vip.jpg'  ,fit: BoxFit.cover,
                            ),
                          ),
                        ),
                        SizedBox(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      ListTile(
                        ...
                        title: Text('ShopNice Axis Bank Credit Card'),
                        subtitle: Text('Apply & enter world of unlimited benefits!'),
                        trailing: Icon(Icons.arrow_forward_ios),
                      ),
                      ListTile(
                        leading: Icon(Icons.payment, color: Colors.orange),
                        title: Text('ShopNice Pay Later'),
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      ListTile(
                        ...
                        title: Text('ShopNice Creater Studio'),
